...
import 'package:thinkflow/thinkflow/user/service/review.dart';
import 'package:thinkflow/thinkflow/user/video/videopage.dart';
                            ...
                            children: [
                                  ...
                                  ElevatedButton.icon(
                                    onPressed: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              CourseVideosPage(courseId:widget.courseId,),
                                        ),
                                      );
                                    },
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  _buildSaveCourseButton(widget.courseId, themeProvider)
                                ],
                              ),
                              SizedBox(height: 16),
...
Widget _buildSaveCourseButton(String courseId, ThemeProvider themeProvider) {
          ...
          onPressed: () async {
            ...
            if (isSaved) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Removed from saved courses')),
              );
            } else {
              await ref.set({'savedAt': FieldValue.serverTimestamp()});
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Added to saved courses')),
              );
            }
